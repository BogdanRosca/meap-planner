...
describe('Home Component', () => {
  test('renders search results when search query is provided', () => {
    ...
    expect(screen.getByText('Search functionality will be implemented here')).toBeInTheDocument();
  });

  test('does not render welcome section when search query is provided', () => {
    render(<Home searchQuery="chicken" />);
    
    expect(screen.queryByText('Welcome to Meal Planner')).not.toBeInTheDocument();
