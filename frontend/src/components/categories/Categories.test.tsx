...
describe('Categories Component', () => {
  ...
  it('applies correct CSS custom properties for category colors', () => {
    ...
    const breakfastButton = screen.getByText('Breakfast').closest('button') as HTMLElement;
    const snackButton = screen.getByText('Snack').closest('button') as HTMLElement;
    const lunchButton = screen.getByText('Lunch').closest('button') as HTMLElement;
  ...
  it('has proper accessibility attributes', () => {
    ...
    const categorySpecificButtons = categoryButtons.filter(button => 
  ...
  it('renders categories in correct order', () => {
    ...
    const categoryNames = screen.getAllByText(/^(Breakfast|Snack|Lunch|Dinner)$/);
  ...
  it('has correct category data structure', () => {
    ...
    const breakfastCategory = screen.getByText('Breakfast').closest('.category-item');
